...
public class EmployeeConverter {
	...
	public EmployeeModel entityToModel(Employee employee) {
		return new EmployeeModel(employee.getId(),employee.getName(),employee.getSurname(),employee.getDateBirth(),employee.getDni(),employee.isManager(), employee.getStartTime(), employee.getEndTime(), employee.getBasicSalary(), employee.getCommission()); 
	}
